...
kappa_score_general_filename = checkpoint_path+'kappa_score_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
acc_balanced_filename = checkpoint_path+'acc_balanced_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
acc_filename = checkpoint_path+'acc_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
acc_macro_filename = checkpoint_path+'acc_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
acc_micro_filename = checkpoint_path+'acc_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
confusion_matrix_filename = checkpoint_path+'conf_matr_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
roc_auc_filename = checkpoint_path+'roc_auc_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
f1_score_macro_filename = checkpoint_path+'f1_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
f1_score_micro_filename = checkpoint_path+'f1_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
hamming_loss_filename = checkpoint_path+'hamming_loss_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
recall_score_macro_filename = checkpoint_path+'recall_score_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
recall_score_micro_filename = checkpoint_path+'recall_score_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
jaccard_score_macro_filename = checkpoint_path+'jaccard_score_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
jaccard_score_micro_filename = checkpoint_path+'jaccard_score_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
roc_auc_score_macro_filename = checkpoint_path+'roc_auc_score_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
roc_auc_score_micro_filename = checkpoint_path+'roc_auc_score_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
precision_score_macro_filename = checkpoint_path+'precision_score_macro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
precision_score_micro_filename = checkpoint_path+'precision_score_micro_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
auc_score_filename = checkpoint_path+'auc_score_SS_'+TASK+'_'+MAGNIFICATION+'_WSI_'+DATASET_TO_SELECT+'.csv'
...
with torch.no_grad():
	...
	for inputs_bag,labels in testing_generator_bag:
		...
		for b in range(len_bag):
			...
			predictions, _, _ = model(None, inputs)
	...
	if (TASK=='binary' and N_CLASSES==1):
		...
		filename_training_predictions = checkpoint_path+'WSI_predictions_'+DATASET_TO_SELECT+'_SINGLE_SCALE_MAGNIFICATION_'+str(MAGNIFICATION)+'x_'+str(TASK)+'.csv'
